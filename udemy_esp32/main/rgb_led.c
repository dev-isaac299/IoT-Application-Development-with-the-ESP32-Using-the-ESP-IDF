...
/*
 * @brief: handle for rgb_led_pwm_init
*/
bool g_pwm_init_handle	= false;

/*
 * @brief: Initialize the RGB LED settings per channel, including
 * the GPIO for each, mode and timer configuration.
 *
 *
 */
